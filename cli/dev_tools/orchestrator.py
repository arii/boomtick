...
class Orchestrator:
    ...
    def evaluate_pr_heuristics(self, pr: Dict[str, Any], diff: str, checks: Dict[str, Any]) -> str:
        ...
        if pr.get("mergeable") is False:
            ...
            feedback += f"  - *Fix:* Pull `{base_branch_name}` into your branch, resolve the conflicts (e.g., via `{PROJECT_CONFIG.cli_alias} gh detect-conflicts`), and force push.\n"
    ...
    def create_pull_request(
        self, title: str, body: str, head: str, base: str = "main", draft: bool = False, repo: Optional[str] = None
    ) -> Dict[str, Any]:
        """
